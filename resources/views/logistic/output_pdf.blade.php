    ...
    <table width="100%" class="border" border="1">
        <tr style="min-height:150px;">
            <td style="font-size:10px;">
                <dl>
                    <dt><small>PUNTO PARTIDA</small></dt>
                    <dd>{{ ($row->warehouse->address) ? $row->warehouse->address->address : '--' }}</dd>
                    <dd>
                        {{ ($row->bpartner->address_fiscal) ? $row->bpartner->address_fiscal->state->statename : '' }} - 
                        {{ ($row->bpartner->address_fiscal) ? $row->bpartner->address_fiscal->county->countyname : '' }} - 
                        {{ ($row->bpartner->address_fiscal) ? $row->bpartner->address_fiscal->city->cityname : '' }}
                ...
                <dl>
                    <dt><small>PUNTO LLEGADA</small></dt>
                    <dd>{{ ($row->bpartner->address_delivery) ? $row->bpartner->address_delivery->address : '--' }}</dd>
                    <dd>
                        {{ ($row->bpartner->address_fiscal) ? $row->bpartner->address_fiscal->state->statename : '' }} - 
                        {{ ($row->bpartner->address_fiscal) ? $row->bpartner->address_fiscal->county->countyname : '' }} - 
                        {{ ($row->bpartner->address_fiscal) ? $row->bpartner->address_fiscal->city->cityname : '' }}
