    ...
    <div class="container-fluid">
        <div class="row mb-0">
            <div class="col-sm-6">
                ...
                <div class="btn-group">
                    <a href="{{ route('bpartner_rpt_receivable_pdf') }}" class="btn btn-default btn-sm"  data-toggle="modal" data-target="#ModalFilter">
                        <i class="fas fa-download fa-fw"></i>
                        PDF
                    </a>
                    <a href="{{ route('bpartner_rpt_receivable_csv') }}" class="btn btn-default btn-sm"  data-toggle="modal" data-target="#ModalFilter">
                        <i class="fas fa-download fa-fw"></i>
                        CSV
                    </a>
                </div>
