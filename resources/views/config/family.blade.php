    ...
    <div class="container-fluid">
        <div class="row mb-0">
            <div class="col-sm-6">
                ...
                <a class="btn btn-sm btn-success" href="{{ route('productfamily.create') }}" title="Marcar como página de inicio">
            ...
            <tbody>
                @forelse ($result as $item)
                    <tr id="tr-{{ $item->id }}">
                        ...
                        <td class="text-right">
                            <a href="{{ route('productfamily.edit',[$item->token]) }}">
                                <i class="fas fa-pen-square fa-fw"></i>
                                Modificar
                            </a>
                            |
                            <a class="delete-record" data-url="{{ route('productfamily.destroy', $item->token) }}"
