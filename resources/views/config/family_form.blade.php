    ...
    <div class="card">
                ...
                <li class="nav-item">
                    <span class="nav-link active">
                        ...
                        <span class="d-none d-sm-inline-block">
                            Informacion Familia [<strong>{{ ($mode == 'new') ? 'NUEVO' : 'MODIFICANDO' }}]</strong>
                        </span>                
                    </span>
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <input type="text" name="familyname" value="{{ $row->familyname }}" class="form-control" placeholder="Denominacion" required>
                </div>
                <div class="col-md-3">
        ...
        <div class="card-footer">
            ...
            <div class="float-right">
                <a href="{{ route('productfamily.index') }}" class="btn btn-default"> <i class="fas fa-times"></i> Cancelar</a>                
